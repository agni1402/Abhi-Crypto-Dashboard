    ...
    render() {
        return (
            <div>
                ...
                <section className="row m-3 mb-0" style={{ maxWidth: "100%", marginTop: ' 2px !important' }}>
                    <div className="card text-white text-center  m-3"
                        style={{ borderRadius : "20px",  maxWidth: "11rem", backgroundColor: "rgb(43, 43, 43)", marginTop: "0px !important" }}>
                    ...
                    <div className="card text-white text-center  m-3"
                        style={{ borderRadius : "20px", width: "11rem", backgroundColor: "rgb(43, 43, 43)", marginTop: "0px !important" }}>
                        <div className="card-body">
